...
#
# #r = requests.get('http://httpbin.org/get?name=jy&age=18')
# r = requests.get('https://movie.douban.com/top250?start=50&filter=')
# r.headers={"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36"
# }
#
# soup = BeautifulSoup(r.text,"html.parser")
# print(soup.prettify())
# movieList = soup.find('ol',attrs={'calss':'grid_view'})
