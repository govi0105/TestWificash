'''=================================================
@Project -> File   ：TestWificash -> basepage
@IDE    ：PyCharm
@Author ：高伟
...
class BasePage:
    ...
    def __init__(self,driver):
        self.driver = driver
        #webdriver.Chrome("C:/Program Files (x86)/Google/Chrome/Application/chromedriver.exe",service_log_path="D:/test.log")
    ...
    def save_webImg(self,model_name):
        ...
        try:
            ...
            self.driver.get_screenshot_as_file("D:/TestWificash/Outputs/Screenshots/{0}_{1}.png".format(model_name,picture_time))
