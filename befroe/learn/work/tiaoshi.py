...
def music():
    ...
    for i in range(len(list_id)):
        ...
        if yz in list_id[i]:
            ...
            # list_name[i] = "-----"
    # 内容第二列
    b1 = tk.Label(root, text=list_name[0], fg='#d834c3', bg="#f3cff1", font=12, width=40)
    b1.grid(row=1, column=1, sticky=tk.W)
    b2 = tk.Label(root, text=list_name[1], fg='#d834c3', bg="#f3cff1", font=12, width=40)
    b2.grid(row=2, column=1, sticky=tk.W)
    b3 = tk.Label(root, text=list_name[2], fg='#d834c3', bg="#f3cff1", font=12, width=40)
    b3.grid(row=3, column=1, sticky=tk.W)
    b4 = tk.Label(root, text=list_name[3], fg='#d834c3', bg="#f3cff1", font=12, width=40)
    b4.grid(row=4, column=1, sticky=tk.W)
    b5 = tk.Label(root, text=list_name[4], fg='#d834c3', bg="#f3cff1", font=12, width=40)
...
# #内容第五列
e1 = tk.Label(root, text='待完善', fg='red', font=12,highlightbackground = "yellow",highlightcolor = "white",anchor = "w",)
